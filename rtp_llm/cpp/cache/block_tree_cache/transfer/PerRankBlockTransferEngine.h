...
private:
    ...
    TransferStatus     validateBatchDescriptor(const TransferDescriptor& desc, const GroupSet*& group_set) const;
    TransferStatus     validateBatchDeviceBlocks(const TransferDescriptor& desc, const GroupSet& group_set) const;
